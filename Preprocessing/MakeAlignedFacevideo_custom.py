...
ImageDir_junhan = "/mnt/home/qualcomm/customdata/junhan/"
ImageDir_junsu  = "/mnt/home/qualcomm/customdata/junsu/"
saveDir = "/mnt/home/qualcomm/customdata/alignedFaceVideo/"

print("\n\n===========process for junhan==================")
imageFileList = [f for f in listdir(ImageDir_junhan) if isfile(join(ImageDir_junhan, f))]
...
for imageFile in imageFileList:
    ...
    cap = cv2.VideoCapture(ImageDir_junhan + imageFile)
...
print("\n\n===========process for junsu==================")
imageFileList = [f for f in listdir(ImageDir_junsu) if isfile(join(ImageDir_junsu, f))]
imageNum = len(imageFileList)
imageIndex = 0
for imageFile in imageFileList:
    imageIndex += 1
    ...
    print("image : " + imageFile)
    print("Processing " + str(imageIndex) + " / " + str(imageNum) + "images ... ")
    cap = cv2.VideoCapture(ImageDir_junsu + imageFile)
    frameCount = int(cap.get(cv2.CAP_PROP_FRAME_COUNT))
    frameInterval = frameCount // 10
    print("frame Count is : " + str(frameCount))
    print(frameInterval)
